...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.totalRows = this.allTypeOfLaboratories.length;
        ...
        methods: {
          ...
          ...mapActions(['fetchTypeOfLaboratories', 'deleteTypeOfLaboratory']),
          ...
          create() {
            ...
            this.$router.push({ name: 'typeOfLaboratory-create' });

          },

          update(item) {

            this.$router.push({ name: 'typeOfLaboratory-create', params: { id: item.id } });

          },

          show(item) {

            this.$router.push({ name: 'typeOfLaboratory-show', params: { id: item.id } });
          ...
          destroy(item) {
            ...
            .then((willDelete) => {
              ...
              if (willDelete) {
                  ...
                  const response = this.deleteTypeOfLaboratory(item.id);

                  response.then( response => {
                      console.log(response.data);
                      if(response.data.message === 'success') {

                          toastr.success('Type of laboratory successfully deleted.', 'Message');
