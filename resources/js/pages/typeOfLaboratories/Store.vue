...
<script>
    ...
    export default {
        ...
        methods: {
          ...
          ...mapActions(['addTypeOfLaboratory', 'updateTypeOfLaboratory', 'showTypeOfLaboratoryById']),
          ...
          onSubmit(event) {
            ...
            if(this.$route.params.id > 0) {
              ...
              const response = this.updateTypeOfLaboratory({id: this.$route.params.id, formData: formData});
              ...
              response.then( response => {
                  if(response.data.message === 'success') {
                      ...
                      toastr.success('Type of laboratory successfully updated.', 'Message');
              ...
              const response = this.addTypeOfLaboratory(formData);
              ...
              response.then(response => {
                  ...
                  if(response.data.message === 'success') {
                      ...
                      toastr.success('Type of laboratory successfully saved.', 'Message');
