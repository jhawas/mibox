              ...
              <div class="tile">
                <div class="tile-body">
                    <fulfilling-bouncing-circle-spinner
                      ...
                      class="ibox-spinner"
                    />
                    <b-card title="Diagnose Information" v-if="!loading">
                      <b-row>
                        <b-col col md="6">
                            <b-form-group label-cols="4" label-cols-lg="2" label="Name" label-for="input-default">
                              <div class="form-control form-group-value">{{ diagnose.name }}</div>
                            </b-form-group>

                            <b-form-group label-cols="4" label-cols-lg="2" label="Description" label-for="input-default">
                              <div class="form-control form-group-value">{{ diagnose.description }}</div>
                            </b-form-group>

                            <b-form-group label-cols="4" label-cols-lg="2" label="Parent" label-for="input-default">
                              <div class="form-control form-group-value">{{ diagnose.parent ? diagnose.parent.name : null }}</div>
                            </b-form-group>
