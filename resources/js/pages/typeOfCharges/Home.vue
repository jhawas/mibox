                ...
                <div class="tile-body">
                    <b-container fluid>
                      ...
                      <b-row>
                        ...
                        <b-col md="6" class="my-1" v-if="hasAccess('create-typeOfCharge')">
                      ...
                      >
                        ...
                        <template slot="actions" slot-scope="row" right>
                            ...
                            <b-button v-if="hasAccess('view-typeOfCharge')">
                                <i class="fa fa-eye" @click="show(row.item)" aria-hidden="true"></i>
                            </b-button>
                            
                            <b-button @click="update(row.item)" v-if="hasAccess('update-typeOfCharge')">
                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                            </b-button>
                            <b-button @click="destroy(row.item)" v-if="hasAccess('delete-typeOfCharge')">
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.totalRows = this.allTypeOfCharges.length;

        },

        computed: {

          ...mapGetters(['allTypeOfCharges', 'hasAccess']),
        ...
        methods: {
          ...
          ...mapActions(['fetchTypeOfCharges', 'deleteTypeOfCharge']),
          ...
          create() {
            ...
            this.$router.push({ name: 'typeOfCharge-create' });

          },

          update(item) {

            this.$router.push({ name: 'typeOfCharge-create', params: { id: item.id } });

          },

          show(item) {

            this.$router.push({ name: 'typeOfCharge-show', params: { id: item.id } });
          ...
          destroy(item) {
            ...
            .then((willDelete) => {
              ...
              if (willDelete) {
                  ...
                  const response = this.deleteTypeOfCharge(item.id);

                  response.then( response => {
                      console.log(response.data);
                      if(response.data.message === 'success') {

                          toastr.success('Type of charge successfully deleted.', 'Message');
