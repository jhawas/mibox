...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.totalRows = this.allFloors.length;
        ...
        methods: {
          ...
          ...mapActions(['fetchFloors', 'deleteFloor']),
          ...
          update(item) {
            ...
            this.$router.push({ name: 'floor-create', params: { id: item.id } });

          },

          show(item) {

            this.$router.push({ name: 'floor-show', params: { id: item.id } });
          ...
          destroy(item) {
            ...
            .then((willDelete) => {
              ...
              if (willDelete) {
                  ...
                  const response = this.deleteFloor(item.id);
