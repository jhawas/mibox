...
<script>
    ...
    export default {
        ...
        methods: {
          ...
          ...mapActions(['addFloor', 'updateFloor', 'showFloorById']),
          ...
          onSubmit(event) {
            ...
            if(this.$route.params.id > 0) {
              ...
              const response = this.updateFloor({id: this.$route.params.id, formData: formData});
              ...
              response.then( response => {
                  if(response.data.message === 'success') {
                      ...
                      toastr.success('Floor successfully updated.', 'Message');
              ...
              const response = this.addFloor(formData);
              ...
              response.then(response => {
                  ...
                  if(response.data.message === 'success') {
                      ...
                      toastr.success('Floor successfully saved.', 'Message');
