                ...
                <div class="tile-body">
                    <b-container fluid>
                      ...
                      <b-row>
                        ...
                        <b-col md="6" class="my-1" v-if="hasAccess('create-vitalSign')">
                      ...
                      >
                        ...
                        <template slot="actions" slot-scope="row" right>
                            <b-button v-if="hasAccess('view-vitalSign')">
                                <i class="fa fa-eye" @click="show(row.item)" aria-hidden="true"></i>
                            </b-button>
                            
                            <b-button @click="update(row.item)" v-if="hasAccess('update-vitalSign')">
                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                            </b-button>
                            <b-button @click="destroy(row.item)" v-if="hasAccess('delete-vitalSign')">
    ...
    export default {
        ...
        methods: {
          ...
          create() {
            ...
            this.$router.push({ name: 'vitalSign-create' });

          },

          update(item) {

            this.$router.push({ name: 'vitalSign-create', params: { id: item.id } });

          },

          show(item) {

            this.$router.push({ name: 'vitalSign-show', params: { id: item.id } });
          ...
          destroy(item) {
            ...
            .then((willDelete) => {
              ...
              if (willDelete) {
                  ...
                  const response = this.deleteVitalSign(item.id);

                  response.then( response => {
                      console.log(response.data);
                      if(response.data.message === 'success') {

                          toastr.success('Vital sign successfully deleted.', 'Message');
