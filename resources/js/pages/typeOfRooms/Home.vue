...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.totalRows = this.allTypeOfRooms.length;
        ...
        methods: {
          ...
          ...mapActions(['fetchTypeOfRooms', 'deleteTypeOfRoom']),
          ...
          create() {
            ...
            this.$router.push({ name: 'typeOfRoom-create' });

          },

          update(item) {

            this.$router.push({ name: 'typeOfRoom-create', params: { id: item.id } });

          },

          show(item) {

            this.$router.push({ name: 'typeOfRoom-show', params: { id: item.id } });
          ...
          destroy(item) {
            ...
            .then((willDelete) => {
              ...
              if (willDelete) {
                  ...
                  const response = this.deleteTypeOfRoom(item.id);
