                ...
                <div class="tile-body">
                    <b-container fluid>
                      ...
                      <b-row>
                        ...
                        <b-col md="6" class="my-1" v-if="hasAccess('create-patientDiagnoses')">
                      ...
                      >
                        ...
                        <template slot="actions" slot-scope="row" right>
                            ...
                            <b-button @click="destroy(row.item)" v-if="hasAccess('delete-patientDiagnoses')">
    ...
    export default {
        ...
        methods: {
          ...
          create() {
            ...
            this.$router.push({ name: 'patientDiagnose-create' });

          },

          update(item) {

            this.$router.push({ name: 'patientDiagnose-create', params: { id: item.id } });

          },

          show(item) {

            this.$router.push({ name: 'patientDiagnose-show', params: { id: item.id } });
          ...
          destroy(item) {
            ...
            .then((willDelete) => {
              ...
              if (willDelete) {
                  ...
                  const response = this.deletePatientDiagnose(item.id);
