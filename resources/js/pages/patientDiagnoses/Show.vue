              ...
              <div class="tile">
                <div class="tile-body">
                    <fulfilling-bouncing-circle-spinner
                      ...
                      class="ibox-spinner"
                    />
                    <b-card title="Patient Diagnoses Information" v-if="!loading">
                      <b-row>
                        <b-col col md="6">
                          
                            <b-form-group label-cols="4" label-cols-lg="2" label="Patient" label-for="input-default">
                              <div class="form-control form-group-value">{{ patientDiagnose.patient_record.full_name }}</div>
                            </b-form-group>

                             <b-form-group label-cols="4" label-cols-lg="2" label="Diagnoses" label-for="input-default">
                              <div class="form-control form-group-value">{{ patientDiagnose.diagnose.name }}</div>
                            </b-form-group>

                            <b-form-group label-cols="4" label-cols-lg="2" label="Description" label-for="input-default">
                              <div class="form-control form-group-value">{{ patientDiagnose.description }}</div>
                            </b-form-group>

                            <b-form-group label-cols="4" label-cols-lg="2" label="Remarks" label-for="input-default">
                              <div class="form-control form-group-value">{{ patientDiagnose.remarks }}</div>
                            </b-form-group>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapGetters(['allPatientDiagnoses']),
        },
        ...
        methods: {
          ...
          ...mapActions(['showPatientDiagnoseById']),
