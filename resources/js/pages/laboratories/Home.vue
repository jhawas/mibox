                ...
                <div class="tile-body">
                    <b-container fluid>
                      ...
                      <b-row>
                        ...
                        <b-col md="6" class="my-1" v-if="hasAccess('create-laboratory')">
                      ...
                      >
                        ...
                        <template slot="parent" slot-scope="row">
                          ...
                          {{ row.item.parent ? row.item.parent.name : null }}
                            
                        </template>

                        <template slot="actions" slot-scope="row" right>

                            <b-button v-if="hasAccess('view-laboratory')">
                                <i class="fa fa-eye" @click="show(row.item)" aria-hidden="true"></i>
                            </b-button>
                            
                            <b-button @click="update(row.item)" v-if="hasAccess('update-laboratory')">
                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                            </b-button>
                            <b-button @click="destroy(row.item)" v-if="hasAccess('delete-laboratory')">
    ...
    export default {
        ...
        methods: {
          ...
          update(item) {
            ...
            this.$router.push({ name: 'laboratory-create', params: { id: item.id } });

          },

          show(item) {

            this.$router.push({ name: 'laboratory-show', params: { id: item.id } });
          ...
          destroy(item) {
            ...
            .then((willDelete) => {
              ...
              if (willDelete) {
                  ...
                  const response = this.deleteLaboratory(item.id);

                  response.then( response => {
                      console.log(response.data);
                      if(response.data.message === 'success') {

                          toastr.success('Laboratory successfully deleted.', 'Message');
