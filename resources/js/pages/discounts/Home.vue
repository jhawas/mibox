                ...
                <div class="tile-body">
                    <b-container fluid>
                      ...
                      <b-row>
                        ...
                        <b-col md="6" class="my-1" v-if="hasAccess('create-discount')">
                      ...
                      >
                        ...
                        <template slot="actions" slot-scope="row" right>
                            <b-button v-if="hasAccess('view-discount')">
                                <i class="fa fa-eye" @click="show(row.item)" aria-hidden="true"></i>
                            </b-button>
                            
                            <b-button @click="update(row.item)" v-if="hasAccess('update-discount')">
                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                            </b-button>
                            <b-button @click="destroy(row.item)" v-if="hasAccess('delete-discount')">
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.totalRows = this.allDiscounts.length;

        },

        computed: {

          ...mapGetters(['allDiscounts', 'hasAccess']),
        ...
        methods: {
          ...
          update(item) {
            ...
            this.$router.push({ name: 'discount-create', params: { id: item.id } });

          },

          show(item) {

            this.$router.push({ name: 'discount-show', params: { id: item.id } });
          ...
          destroy(item) {
            ...
            .then((willDelete) => {
              ...
              if (willDelete) {
                  ...
                  const response = this.deleteDiscount(item.id);
